...
//			filter.start();
			...
			FFmpegFrameRecorder recorder = new FFmpegFrameRecorder("C:\\Users\\Administrator\\Desktop\\demo1.mp4", ff.getImageWidth(), ff.getImageHeight(), ff.getAudioChannels());
